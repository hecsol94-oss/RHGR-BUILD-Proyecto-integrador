...
public class VentanaOficial extends JFrame {
    ...
    private JPanel construirDashboard() {
        ...
        gbc.gridy = 1;
        gbc.gridx = 0; panelTarjetas.add(crearTarjetaDashboard("CITAS HOY", lblCitasHoy), gbc);
        gbc.gridx = 2; panelTarjetas.add(crearTarjetaDashboard("PLAN SEMANA", lblCitasSemana), gbc);
