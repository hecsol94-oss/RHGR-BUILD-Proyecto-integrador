...
public class VentanaMaestro extends JFrame {
     ...
     * Inicializa el menú, el header y el sistema de navegación basado en CardLayout.
     */
    ...
    private JPanel construirDashboard() {
        ...
        gbc.gridx = 3; panelTarjetas.add(crearTarjetaDashboard("CLIENTES", lblTotalClientes), gbc);

        gbc.gridy = 1;
        gbc.gridx = 0; gbc.gridwidth = 2; panelTarjetas.add(crearTarjetaDashboard("CITAS HOY", lblCitasHoy), gbc);
        gbc.gridx = 2; gbc.gridwidth = 2; panelTarjetas.add(crearTarjetaDashboard("PLAN SEMANA", lblCitasSemana), gbc);
