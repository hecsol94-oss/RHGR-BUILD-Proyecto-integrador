	 ...
	 private VentanaOficial vista;
	    ...
	    private void cargarContadores() {
	        try {
	            ...
	            // Las "mis citas" del oficial son todas las citas (sin tabla de asignación individual)
	    ...
	    // Abre el formulario para que el oficial complete la cita asignada por el maestro
	    private void abrirNuevaCita() {
	        NuevaCitaOficial vistaForm = new NuevaCitaOficial();
	        new ControladorNuevaCitaOficial(vistaForm, acceso, c);
