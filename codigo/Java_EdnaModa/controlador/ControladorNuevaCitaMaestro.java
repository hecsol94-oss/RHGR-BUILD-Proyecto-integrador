...
// Rellenamos con la informacion de l base de datos
	...
	private void abrirNuevoCliente() {
		...
		new ControladorNuevoCliente(vistaCliente, acceso, c, null);
	...
	private void abrirNuevoTaller() {
		...
		new ControladorNuevoTaller(vistaTaller, acceso, c, talleres, empleado);
