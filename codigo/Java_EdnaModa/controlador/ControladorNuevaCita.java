...
public class ControladorNuevaCita {
    ...
    private void guardarCita() {
        ...
        try {
            ...
            if (idxApr1 > 0) {
                for (Empleado emp : listaEmpleados) {
                    if ((emp.getNombre() + " " + emp.getApellido()).equals(nombreApr1)) {
                    	if ((aprendizAEditar1 == null && citaAEditar != null) || (aprendizAEditar1 == null && citaAEditar == null)) {
            ...
            if (idxApr2 > 0) {
                for (Empleado emp : listaEmpleados) {
                    if ((emp.getNombre() + " " + emp.getApellido()).equals(nombreApr2)) {
                    	if ((aprendizAEditar2 == null && citaAEditar != null) || (aprendizAEditar2 == null && citaAEditar == null)) {
                    		acceso.insertarNuevaCita_Aprendiz(c, new Cita_Aprendiz(0, idCitaReal, emp.getId_empleado()));
                            break;
                    	} else {
            ...
            if (idxApr1 <= 0 && idxApr2 <= 0) {
                ...
                // Refrescar datos y volver a la lista
    ...
    private void cancelar() {
		try {
			...
			ListaCitas lc = new ListaCitas();
	    	new ControladorListaCitas(lc, acceso, c, citas, aprendicesConCita, empleado);
	    	lc.setVisible(true);	
